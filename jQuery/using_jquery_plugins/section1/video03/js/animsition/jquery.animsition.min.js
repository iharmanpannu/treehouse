...
!(function(a) {
  ...
  var b = "animsition",
    c = {
      ...
      addOverlay: function(b) {
        a(b.overlayParentElement).prepend(
          '<div class="' + b.overlayClass + '"></div>'
        );
      },
      addLoading: function(b) {
        a(b.loadingParentElement).append(
          '<div class="' + b.loadingClass + '"></div>'
        );
      },
        ...
        return (
          i || j
            ...
            : d && e
              ...
              : !d && e
                ? (c = g.inDuration)
                : d && !e ? (c = g.outClass) : d || e || (c = g.outDuration),
          c
        );
      },
      pageIn: function() {
      ...
      pageInBasic: function(b, c) {
        var d = a(this);
        d
          .css({ "animation-duration": c / 1e3 + "s" })
          .addClass(b)
      ...
      pageInOverlay: function(c, d) {
        var e = a(this),
          f = e.data(b).options;
        e.css({ opacity: 1 }),
          a(f.overlayParentElement)
            .children("." + f.overlayClass)
            .css({ "animation-duration": d / 1e3 + "s" })
            .addClass(c);
      },
      pageOut: function(d) {
        var e = this,
      ...
      pageOutOverlay: function(d, e, f) {
        ...
        a(i.overlayParentElement)
          .children("." + i.overlayClass)
  ...
  (a.fn.animateCallback = function(b) {
    ...
    (a.fn.animsition = function(d) {
      return c[d]
        ? c[d].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof d && d
          ? void a.error("Method " + d + " does not exist on jQuery." + b)
